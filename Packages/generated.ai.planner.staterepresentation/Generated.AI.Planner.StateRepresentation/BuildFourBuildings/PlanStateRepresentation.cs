...
namespace Generated.AI.Planner.StateRepresentation.BuildFourBuildings
{
    ...
    public struct TraitBasedObject : ITraitBasedObject, IEquatable<TraitBasedObject>
    {
        ...
        public bool Equals(TraitBasedObject other)
        {
                ...
                return LocationIndex == other.LocationIndex && BuildableIndex == other.BuildableIndex && PlanningAgentIndex == other.PlanningAgentIndex;
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                    ...
                    var hashCode = LocationIndex.GetHashCode();
                     ...
                     hashCode = (hashCode * 397) ^ BuildableIndex.GetHashCode();
